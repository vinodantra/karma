...
class CreateAnsController extends GetxController {
...
//         addressList.value = jsonData.containsKey("ADDRESS") ? jsonData['ADDRESS'] : [];
//         fAddressList.value = jsonData.containsKey("ADDRESS") ? jsonData['ADDRESS'] : [];
//         tallySrNo.value = jsonData.containsKey("TALLYSRNO") ? jsonData['TALLYSRNO'] : [];
//         fTallySrNo.value = jsonData.containsKey("TALLYSRNO") ? jsonData['TALLYSRNO'] : [];
//         contactList.value =  jsonData.containsKey("CONTACT") ? jsonData['CONTACT'] :  [];
//         fContactList.value = jsonData.containsKey("CONTACT") ? jsonData['CONTACT'] :  [];
//         allocationManagerList.value =  jsonData.containsKey("TEAM") ? jsonData['TEAM'] :  [];
//
//         selectSupType.value =
